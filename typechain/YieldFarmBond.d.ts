...
interface YieldFarmBondInterface extends ethers.utils.Interface {
  functions: {
    "EPOCHS_DELAYED_FROM_STAKING_CONTRACT()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "EPOCHS_DELAYED_FROM_STAKING_CONTRACT",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class YieldFarmBond extends Contract {
  ...
  interface: YieldFarmBondInterface;
